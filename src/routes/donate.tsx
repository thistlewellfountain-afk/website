...
export const Route = createFileRoute("/donate")({
  head: () => ({
    meta: [
      { title: "Donate — Thistlewell Fountain Foundation" },
      { name: "description", content: "Support Thistlewell Fountain Foundation. Your donation funds 5,000-litre community water storage tanks in underserved communities across Kabale District, Uganda." },
      { property: "og:title", content: "Donate — Thistlewell Fountain Foundation" },
  ...
  return (
    <>
      <PageHero
        ...
        description="Donations to Thistlewell Fountain Foundation directly support the installation of 5,000-litre water storage tanks in underserved communities across Kabale District and other areas of Uganda."
      />
        ...
        <div className="grid gap-8 lg:grid-cols-[3fr_2fr] lg:items-start">
          ...
          >
            ...
            <p className="mt-3 text-muted-foreground">
              Every donation, in any amount, moves the project forward — from foundation slabs to
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-border bg-card p-6 text-center shadow-sm sm:p-8">
          <p className="text-sm text-muted-foreground">
            Thistlewell Fountain Foundation is a newly established Ugandan NGO. We do not yet claim
