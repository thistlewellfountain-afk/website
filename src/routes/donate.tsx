...
import donationForm from "@/assets/donation-form.pdf";
  ...
  head: () => ({
    meta: [
      { title: "Donate — Thistlewell Fountain" },
      {
        name: "description",
        content:
          "Support Thistlewell Fountain. Your donation funds 5,000-litre community water storage tanks in underserved communities across Kabale District, Uganda.",
      },
      {
        property: "og:title",
        content: "Donate — Thistlewell Fountain",
      },
      {
        property: "og:description",
        content:
          "Bank details and donation options for supporting safe water projects in Kabale District.",
      },
      {
        property: "og:url",
        content: "/donate",
        ...
        <div className="grid gap-8 lg:grid-cols-[3fr_2fr] lg:items-start">
          ...
          >
            ...
            <h2 className="mt-2 text-2xl font-bold sm:text-3xl">
              Donate directly to our official account.
            </h2>

            <p className="mt-3 text-muted-foreground">
              Every donation, in any amount, moves the project forward — from
              foundation slabs to tank installation and community training.
              Please use the details below to send your contribution.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                download="Thistlewell-Donation-Form.pdf"
            ...
            <p className="mt-5 text-xs text-muted-foreground">
              ...
              so we can issue a receipt and thank you personally.
            </p>
          </motion.div>
          ...
          <div className="space-y-6">
            <img
              src={g1}
              alt="Clean water pouring into cupped hands"
            ...
            <div className="rounded-3xl bg-brand p-8 text-brand-foreground shadow-md">
              ...
              <ul className="mt-4 space-y-3 text-sm text-brand-foreground/90">
                ...
                <li>• Foundation slabs, piping and distribution taps</li>
            ...
            <img
              src={g3}
              alt="A child drinking clean water"
              className="h-48 w-full rounded-3xl object-cover shadow-md"
              loading="lazy"
            />
          </div>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-20 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-border bg-card p-6 text-center shadow-sm sm:p-8">
          <p className="text-sm text-muted-foreground">
            Thistlewell Fountain is a newly established Ugandan NGO. We do not
            yet claim completed projects or impact statistics — the numbers on
            this website reflect planned outcomes for our flagship Kabale
            District water storage project.
          </p>
        </div>
      </section>
    </>
