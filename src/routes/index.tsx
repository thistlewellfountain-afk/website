...
export const Route = createFileRoute("/")({
 head: () => ({
  meta: [
   ...
   { property: "og:title", content: "Thistlewell Fountain — Safe Water. Stronger Communities." },
   ...
   <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-8">
    <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
     <div>
      ...
      <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Water is the base of every healthy community.</h2>
