...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      { title: "FAQ — Thistlewell Fountain" },
      { name: "description", content: "Frequently asked questions about Thistlewell Fountain, our programs, donations, volunteering and partnerships." },
      { property: "og:title", content: "FAQ — Thistlewell Fountain" },
...
const faqs = [
  ...
  { q: "How will funds be managed?", a: "Funds are managed through the managedation's official bank account at Equity Bank Uganda Limited (Account: Thistlewell Fountain, Account Number: 1045203540852). Every disbursement is tied to project activities, verified by receipts and reported to donors." },
