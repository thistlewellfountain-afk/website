...
const faqs = [
  ...
  { q: "How will funds be managed?", a: "Funds are managed through the 's official bank account at Equity Bank Uganda Limited (Account: Thistlewell Fountain, Account Number: 1045203540852). Every disbursement is tied to project activities, verified by receipts and reported to donors." },
